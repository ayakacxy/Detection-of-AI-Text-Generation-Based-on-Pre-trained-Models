...
def load_model(path, num_labels=2):
    model = BertForSequenceClassification.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/BERT_Chinese', num_labels=num_labels)
...
# 初始化模型
bert_model = BertModel.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/BERT_Chinese')
...
# 保存模型
save_model(model, '/home/group2024-detect4/.vscode-server/data/User/Detection_Chinese_BERT.pth')
