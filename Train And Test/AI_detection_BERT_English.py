...
def load_model(path, num_labels=2):
    model = BertForSequenceClassification.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/BERT', num_labels=num_labels)
...
class CustomBERTModel(nn.Module):
    def __init__(self, bert, num_labels=2, dropout_rate=0.3):
...
# 初始化分词器
tokenizer = BertTokenizer.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/BERT')
...
# 初始化模型
bert_model = BertModel.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/BERT')
model = CustomBERTModel(bert_model, num_labels=2, dropout_rate=0.3)
...
# 保存模型
save_model(model, '/home/group2024-detect4/.vscode-server/data/User/Detection_English_BERT.pth')
