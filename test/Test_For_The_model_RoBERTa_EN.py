...
def load_model(path, num_labels=2):
    roberta_model = RobertaModel.from_pretrained('RoBERTa_English')
...
if __name__ == "__main__":
    ...
    tokenizer = RobertaTokenizer.from_pretrained('RoBERTa_English')
    ...
    while True:
        ...
        print(f"AI生成的概率: {ai_prob:.6f}, 人类生成的概率: {human_prob:.+f}")
