...
def load_model(path, num_labels=2):
    model = RobertaForSequenceClassification.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/RoBERTa_English', num_labels=num_labels)
...
# 初始化分词器
tokenizer = RobertaTokenizer.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/RoBERTa_English')
...
# 初始化模型
roberta_model = RobertaModel.from_pretrained('/home/group2024-detect4/.vscode-server/data/User/RoBERTa_English')
...
# 保存模型
save_model(model, '/mnt/data2/Detection_English_RoBERTa_try_1.pth')
